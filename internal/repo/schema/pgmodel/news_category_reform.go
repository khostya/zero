...
// Name returns a view or table name in SQL database ("news_category").
...
// NewsCategoryView represents news_category view or table in SQL database.
var NewsCategoryView = &newsCategoryViewType{
	s: parse.StructInfo{
		Type:    "NewsCategory",
		SQLName: "news_category",
